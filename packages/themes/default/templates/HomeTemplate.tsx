...
import { Hero, ClientShowcase } from '../components/organisms';
import { ServiceCard, WorkCard } from '../components/molecules';
...
export default function HomeTemplate({ frontmatter }: HomeTemplateProps) {
  const clients = [
      ...
      <section className="bg-background py-16">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
              Explore some of our recent projects and the impact we've made for
              our clients.
            </p>
          </div>
