...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses = cn(
      'inline-flex items-center justify-center font-normal transition-all duration-normal focus:outline-none dwarves-focus-ring disabled:opacity-50 disabled:cursor-not-allowed',
